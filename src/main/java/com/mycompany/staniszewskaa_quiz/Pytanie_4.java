...
public class Pytanie_4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pytanie 4");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Obserwable stosuje się w :");

        btnGroup1.add(jrbtn1);
        jrbtn1.setText("Mechanice kwantowej");
        ...
        jrbtn3.setText("Fizyce jądrowej");

        btnGroup1.add(jrbtn4);
        jrbtn4.setText("Chemii organicznej");
    ...
    private void btnDalejActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDalejActionPerformed
        if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected())
        {
            ...
            new Pytanie_5(wynik).setVisible(true);
            this.dispose();
        }
    ...
    private void btnSprawdzActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSprawdzActionPerformed
        ...
        else
        {
            ...
            {
            lblWynik.setText("Błędna odpowiedź! - Poprawna to: Mechanice kwantowej");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pytanie_4(0).setVisible(true);
            }
        });
    }
