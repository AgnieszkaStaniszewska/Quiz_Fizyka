...
public class Pytanie_3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pytanie 3");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Zakres promieniowania widzialnego wynosi:");

        btnGroup1.add(jrbtn1);
        jrbtn1.setText("200 nm - 950 nm");
        ...
        jrbtn2.setText("380 nm - 780 nm");

        btnGroup1.add(jrbtn3);
        jrbtn3.setText("380 μm - 780 μm");

        btnGroup1.add(jrbtn4);
        jrbtn4.setText("220 nm - 690 nm");
    ...
    private void btnDalejActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDalejActionPerformed
        if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected())
        {
            ...
            new Pytanie_4(wynik).setVisible(true);
            this.dispose();
        }
    ...
    private void btnSprawdzActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSprawdzActionPerformed
        ...
        else
        {
            ...
            {
            lblWynik.setText("Błędna odpowiedź! - Poprawna to: 380-780 nm");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pytanie_3(0).setVisible(true);
            }
        });
    }
