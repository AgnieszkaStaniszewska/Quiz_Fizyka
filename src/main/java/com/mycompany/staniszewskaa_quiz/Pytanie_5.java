 ...
 */
public class Pytanie_5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pytanie 5");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("W elektrowni jądrowej energia pochodzi z :");

        btnGroup1.add(jrbtn1);
        jrbtn1.setText("Spalania izotopu uranu");
        ...
        jrbtn2.setText("Rozpadu alfa");

        btnGroup1.add(jrbtn3);
        jrbtn3.setText("Spalania węgla");

        btnGroup1.add(jrbtn4);
        jrbtn4.setText("Reakcji rozszczepienia jąder ciężkich izotopów");
    ...
    private void btnDalejActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDalejActionPerformed
        if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected())
        {
            ...
            try {
                ...
                new Wyniki(wynik).setVisible(true);
                this.dispose();
            } catch (FileNotFoundException ex) {
                Logger.getLogger(Pytanie_5.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void btnSprawdzActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSprawdzActionPerformed
        ...
        else
        {
            ...
            {
            lblWynik.setText("Błędna odpowiedź! - Poprawna to: Reakcje rozszczepienia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pytanie_5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pytanie_5(0).setVisible(true);
            }
        });
    }
